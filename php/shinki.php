...
<body>
	...
	<div class="container">
		...
		<div class="col-md-8 col-md-offset-2">
			...
			?>
			<form id="form1" class="form-horizontal" role="form" method="POST" action="/php/shinkicontroller" accept-charset="UTF-8">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label for="Password" class="col-md-4 control-label">パスワードを作成</label>
							<div class="col-md-6">
								<input id="Password" type="password" class="form-control" name="Password" pattern="^([a-zA-Z0-9]{8,})$"  title="半角英数字8桁以上になっているかご確認ください。" required value="" placeholder="半角英数字8桁以上で入力">
							</div>
						</div>
						<div class="form-group">
							<label for="PasswordConfirm" class="col-md-4 control-label">パスワードを再入力</label>
							<div class="col-md-6">
								<input id="PasswordConfirm" type="password" class="form-control" name="PasswordConfirm" pattern="^([a-zA-Z0-9]{8,})$"  title="パスワードが正しいかもう一度ご確認ください。" required value="" placeholder="パスワードを再入力">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="UserPostNum" pattern="\d{3}-\d{4}" title="全角になっていないかハイフン(-)が入っているかもう一度確認してください。" required value="" placeholder="000-0000">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="UserAdress2" class="col-md-4 control-label"></label>
								<div class="col-md-6">
									<input type="text" class="form-control" name="UserAdress2" required placeholder="市町村区～番地">
								</div>
						</div>
						<div class="form-group">
