...
<div class="form-group">
							...
							<div class="col-md-6">
								<POST id="id" type="text" class="form-control" name="name" required autofocus　value="">
							</div>
						</div>
...
<div class="form-group">
							...
							<div class="col-md-6">
								<post id="id" type="text" class="form-control" name="" required autofocus　value="">
							</div>
...
<div class="form-group">
              <label for="id" class="col-md-4 control-label">メールアドレス</label>
            	<div class="col-md-6">
            	<POST id="id" type="text" class="form-control" name="e-mail" required autofocus　value="">
            	</div>
            </div>
<div class="form-group">
              <label for="id" class="col-md-4 control-label">電話番号</label>
            	<div class="col-md-6">
            	<POST id="id" type="text" class="form-control" name="tell" required autofocus　value="">
            	</div>
            </div>
              ...
              <div class="form-group">
              							...
              							<div class="col-md-2">
              							<POST id="id" type="text" class="form-control" name="人数" required autofocus　value="" placeholder=""><label>人</label>
              						</div>
              </div>
<div class="form-group">
        <label for="id" class="col-md-4 control-label">日程</label>
        <post type="text" id="datepickerFrom" placeholder="クリックして下さい"/>

        <label >～</label>
        <POST type="text" id="datepickerTo" placeholder="クリックして下さい"/>
</div>
<div class="form-group">

					<label for="kanso" class="col-md-4 control-label">注意事項</label>
					<div class="col-md-6" >
					<textarea id="kanso"  class="text " name="kanso" cols="48" rows="3" maxlength="20"  placeholder="注意事項を記入"></textarea>
				</div>
</div>
<div class="form-group">
					<label for="id" class="col-md-4 control-label">画像添付</label>
						<POST type="file" name="upload_file[]" multiple id="upload_file" class="data file">
...
<div style="overflow:hidden">
	<div style="float:left;">
		<div style="width:400px;float:left;border-width;">
					<label><POST type="" name="ame"value=""/><img src="/php/image/wi-fi.jpg"></label>
					<label><POST type="checkbox" name="ame"value=""/>電気</label>
					<label><POST type="checkbox" name="ame"value=""/>水道</label><br>
					<label><POST type="checkbox" name="ame"value=""/>駐車場</label>
					<label><POST type="checkbox" name="ame"value=""/>トイレ</label>
					<label><POST type="checkbox" name="ame"value=""/>ガス</label><br>
					<label><POST type="checkbox" name="ame"value=""/>バリアフリー</label>
					<label><POST type="checkbox" name="ame"value=""/>飲食</label>
					<label><POST type="checkbox" name="ame"value=""/>冷暖房使用可能</label>
					<label><POST type="checkbox" name="ame"value=""/>喫煙可能</label>
					<label><POST type="checkbox" name="ame"value=""/>火気使用可能</label>
</div>
</div>
</div>
</div>
...
<div style="overflow:hidden">
	<div style="float:left;">
		<div style="width:400px;float:left;border-width;">
					<label><POST type="checkbox" name="pay"value=""/>現金</label>
					<label><POST type="checkbox" name="pay"value=""/>カード</label>
					<label><POST type="checkbox" name="pay"value=""disabled>暗号通貨</label>
